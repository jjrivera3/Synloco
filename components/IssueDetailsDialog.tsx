...
interface IssueDetailsDialogProps {
  ...
  issue: Issue; // The issue being viewed or edited
  onDelete?: () => void; // Optional callback when the issue is deleted
  onUpdate?: (updatedIssue: Issue) => void; // Optional callback when the issue is updated
  borderCol?: string; // Optional class for styling the border
}
...
export default function IssueDetailsDialog({
  ...
  const canChange =
    user?.id === issue.reporter.id || membership?.role === "org:admin";
