...
export interface SprintCreationFormProps {
  projectTitle: string; // The title of the project
  projectKey: string; // The key of the project
  projectId: string; // The ID of the project (from the Project model)
  sprintKey: string; // The key of the sprint
}

export interface SprintFormData {
  name: string;
  description?: string; // Optional field
  startDate: Date; // Assuming `startDate` is a Date
  endDate: Date; // Assuming `endDate` is a Date
}

const SprintCreationForm: React.FC<SprintCreationFormProps> = ({
  projectTitle,
  projectKey,
  projectId,
  sprintKey,
